...
public class ContentSpecialistService {
    ...
    public record StreamEventDto(String text, String infographicBase64, String infographicMimeType, List<String> artifacts, String finalTextResult) {}
    ...
    public Flowable<Event> runWorkflow(String url, String goal) {
        ...
        Runner runner = InMemoryRunner.builder()
            ...
            .agent(agent)
            .build();
        SessionKey sessionKey = new SessionKey("content_specialist_app", "user", "session_" + System.currentTimeMillis());
